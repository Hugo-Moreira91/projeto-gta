...
botao.addEventListener('click', () => {
    ...
    // Refatorando o código acima (do if-else)
    // Refatorar é reduzir código, sem perder a lógica desejada
    // Na refatoração abaixo, elementoPlataformas recebe e retira a classe ativo, através do método toggle
